...
social:
   fab fa-github: https://github.com/jack-xi-jack || Github || '#24292e'
   fas fa-envelope: mailto:1643699428@qq.com || Email || '#4a7dbe'
   fab fa-weixin: wechat-qr.html || 微信 || "#000000"
# --------------------------------------
# Image Settings
# --------------------------------------
...
aside:
  ...
  card_author:
    ...
    button:
      ...
      icon: fab fa-github
      text: 🛴前往小家...
      link: https://github.com/jack-xi-jack
  card_announcement:
    enable: true
    content: 小熙的技术博客
  card_recent_post:
...
font:
  ...
  code_font_size: '16px'
  font_family:  var(--global-font), Consolas_1, -apple-system, 'Quicksand', 'Nimbus Roman No9 L', 'PingFang SC', 'Hiragino Sans GB', 'Noto Serif SC', 'Microsoft Yahei', 'WenQuanYi Micro Hei', 'ST Heiti', sans-serif;
  code_font_family: Consolas_1, var(--global-font), "Microsoft YaHei", Menlo, "PingFang SC", "Microsoft JhengHei", sans-serif

# Font settings for the site title and site subtitle
blog_title_font:
  font_link:
  font_family:  var(--global-font)
